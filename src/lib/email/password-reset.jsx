  ...
  <Html>
    ...
    <Tailwind>
      <Body className={'my-auto mx-auto font-sans px-2 pb-[20px]'} >
        <Preview>SIS-Faune | Mot de passe temporaire</Preview>
        <Container className={'mx-auto my-[40px] max-w-[465px] px-[20px] items-center'}>
          <Section className={'font-bold text-center'}>
            ...
            <Heading className={'mx-0 my-[30px] p-0 text-[18px]'}>Votre mot de passe temporaire</Heading>
            <Hr />
          </Section>
          <Section>
            <Text className={'text-[16px]'}>Bonjour <strong>{ username }</strong></Text>
            <Text className={'text-[16px]'}>Le mot de passe temporaire suivant vous a été assigné :</Text>
          </Section>
