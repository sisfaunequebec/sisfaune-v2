  ...
  return (
    <>
      ...
      <Flex flex={1} top={0} as={Container} direction={['column', null, 'row']} maxWidth={['6xl']} px={[0, 0, 8]} py={[0, 0, 4]} fontSize={['md', null, 'sm']}>
        <Flex flex={2} p={4} alignItems={'stretch'} bg={'blue.100'} position={'sticky'} top={0} borderColor={'blue.300'} borderTopWidth={1} hideBelow={'md'} />
        <VStack flex={5} justifyContent={'flex-start'} alignItems={'stretch'} ps={[0, null, 2]}>
          ...
          <VStack alignItems={'stretch'} fontSize={['md', null, 'sm']} gap={0}>
            ...
            <AccordionRoot multiple size={['md', null, 'sm']} defaultValue={['general']}>
              <AccordionItem value={'general'}>
                ...
                <AccordionItemContent bg={'white'} p={4} px={6} >Content</AccordionItemContent>
              </AccordionItem>
          ...
          <VStack alignItems={'stretch'} fontSize={['md', null, 'sm']}>
            <Flex flex={1} bg={'green.200'} color={'green.600'} px={6} py={4} fontWeight={500}>Spécimens</Flex>
          </VStack>

          <VStack alignItems={'stretch'} fontSize={['md', null, 'sm']}>
            <Flex flex={1} bg={'green.200'} color={'green.600'} px={6} py={4} fontWeight={500}>Analyses</Flex>
          </VStack>
