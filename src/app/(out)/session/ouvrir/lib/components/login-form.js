        ...
        <Flex as={'form'} autoComplete={'off'} onSubmit={handleSubmit(onSubmit)} direction={'column'} alignItems={'center'} justifyContent={'center'} shadow={'lg'} bg={'white'} p={8} borderRadius={'lg'} w={['full', 'auto']} h={['100%', 'auto']}>
          ...
          <Fieldset.Root size={'lg'} maxW={'280px'} invalid={false}>
            ...
            <Alert.Root status={'warning'}>
              <Alert.Indicator />
              <Alert.Content>
                {/* <Alert.Title><strong>NOTE</strong></Alert.Title> */}
                <Alert.Description>
                  <strong>Si vous rencontrez des difficultés</strong>,<br/>veuillez contacter&nbsp;: santedelafaune@environnement.gouv.qc.ca.
                </Alert.Description>
              </Alert.Content>
            </Alert.Root>
          </Fieldset.Root>
