  ...
  return (
    <Fieldset.Root as={'VStack'} alignItems={'stretch'} size={['lg', null, 'md']}>
      ...
      <Fieldset.Content gap={0.5} mt={2}>
        ...
        <EtatDecouverteSelect label={'État lors de la découverte\u00A0:'} value={discoveryStateId} isEditing={isEditing} />
        <CauseMortSelect label={'Cause de la mort\u00A0:'} value={deathCauseId} isEditing={isEditing} />
      </Fieldset.Content>
      ...
      <Fieldset.Content gap={0.5} mt={2}>
        <AgeSelect label={'Âge\u00A0:'} value={ageId} group={group} isEditing={isEditing} />
        <SexSelect label={'Sexe\u00A0:'} value={sexId} isEditing={isEditing} />
        <MeasureField label={'Circonférence du cou\u00A0:'} value={null} isEditing={isEditing} />
