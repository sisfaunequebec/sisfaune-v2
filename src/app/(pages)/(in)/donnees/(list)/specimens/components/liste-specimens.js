...
const ItemSpecimen = ({ id, eventId, specimenNumber, specieName, specieBinome, cqsasNumber, localityName, submitterName, reportedAt }) => {
    ...
    <LinkListWrapper>
      <Stack flex={1} direction={['column', null, null, 'row']} gap={[0.4, null, null, 1]}>
        <VStack alignItems={'flex-start'} gap={0.4} flex={1}>
          ...
          <Flex>{specieName} (<Text fontStyle={'italic'}>{specieBinome}</Text>)</Flex>
